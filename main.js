var MK = {
  ...
  init: function() {
    ...
    if (typeof window.orientation !== 'undefined') {
      this.parallax.forEach(function(e, i) {
    ...
    window.onscroll = function() {
      ...
      if (typeof window.orientation == 'undefined') {
        self.parallax.forEach(function(e, i) {
          var pos = '50% ' + Math.sqrt(window.pageYOffset) + 'px'
      ...
      if (document.body.scrollTop > 0) {
        document.getElementsByClassName('mkcontainer')[0].style.boxShadow =
          '2px 0px 30px 10px rgba(100, 100, 100, 0.2)'
      } else {
        document.getElementsByClassName('mkcontainer')[0].style.boxShadow =
          'none'
      }
      ...
      //Navbar adjustments
      var dist =
        document.getElementsByClassName('mkcontainer')[0].offsetTop - 25
      ...
      if (
        document.body.scrollTop > dist2 ||
        document.documentElement.scrollTop > dist2
      ) {
        $('#top-right-logo')
          .show()
    ...
    $('.navlink, .down-arrow').on('click', function() {
      $('html,body').animate(
        {
          scrollTop:
            $('#' + this.dataset.section).offset().top -
            $('.header').height() +
            12
        },
        500
